...
//                             <label htmlFor="speedSlider"><h3>Speech Speed (0.25 - 1.75)</h3></label>
//                             <input
//                                 id="speedSlider"
//                                 type="range"
//                                 min="0.25"
...
//                                 }}
//                             />
//                             <span><h4>{speechSpeed.toFixed(2)}</h4></span>
//                         </div>

//                         <div className="slider-container">
//                             <label htmlFor="volumeSlider"><h3>Volume (0 - 100)</h3></label>
//                             <input
//                                 id="volumeSlider"
//                                 type="range"
//                                 min="0"
